                ...
                <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-[70px]'>
                    <div>
                        ...
                        <p className='text-white text-[14px] sm:text-[16px] mb-4 sm:mb-3'>
                            Welcome to weddingbiodata.com your one-stop solution for crafting the perfect marriage biodata! Finding the right life partner is an exciting journey, and we’re here to make it easier for you with our innovative marriage biodata maker.
                        </p>

                        <h3 className='text-white text-[30px] mb-2 mt-8'>Our Vision</h3>
                        <p className='text-white text-[14px] sm:text-[16px] mb-4 sm:mb-3'>
                        ...
                        <h4 className='text-white text-[25px] mb-2 mt-8'>What Sets Us Apart</h4>
                        ...
                        <p className='text-white text-[14px] sm:text-[16px] mb-4 sm:mb-3'>
                            <span className='text-[#fdfdfd] font-bold'> * Customization Options : </span> We understand that every individual is unique. That’s why we offer a wide range of customization options, allowing you to tailor your biodata to reflect your personality and preferences accurately.
                        </p>
                        ...
                        <p className='text-white text-[14px] sm:text-[16px] mb-4 sm:mb-3'>
                            <span className='text-[#fdfdfd] font-bold'> * Privacy and Security : </span>  Your data’s privacy and security are our top priorities. Rest assured that your information is in safe hands, and we adhere to the highest standards of data protection.
                        </p>


                        <h3 className='text-white text-[30px] mb-2 mt-8'>How It Works</h3>
                        <p className='text-white text-[14px] sm:text-[16px] mb-4 sm:mb-3'>
                        ...
                        <p className='text-white text-[14px] sm:text-[16px] mb-4 sm:mb-3'>
                            <span className='text-[#fdfdfd] font-bold'> 1. Download and Share : </span> Once you’re satisfied with your marriage biodata, download it in your preferred format and confidently share it with potential matches.
                        </p>

                        <h3 className='text-white text-[30px] mb-2 mt-8'>Contact Us</h3>
                        <p className='text-white text-[14px] sm:text-[16px] mb-4 sm:mb-3'>
