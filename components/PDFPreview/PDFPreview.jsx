// Import this component to BiodataForm.jsx and use it in the PDF Preview Modal section
import React from 'react';

const PDFPreview = ({ formData, profileImage, selectedTemplate, fieldLabels, fieldOrder, sections }) => {
  return (
    <div className="relative bg-white w-full" style={{ aspectRatio: '1/1.414', maxHeight: '80vh' }}>
      ...
      <div className="relative z-10 p-8 h-full overflow-y-auto">
        ...
        <div className="flex items-center mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#4649C0]">{formData.name || 'Your Name'}</h1>
              ...
              <div className="w-full">
                {fieldOrder[section]?.map((fieldName) => (
                  <div key={fieldName} className="flex mb-2">
                    <div className="w-2/5 font-medium pr-2">{fieldLabels[fieldName]}:</div>
