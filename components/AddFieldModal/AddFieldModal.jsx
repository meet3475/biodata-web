...
const AddFieldModal = ({ show, onClose, onAdd, newFieldName, setNewFieldName, newFieldLabel, setNewFieldLabel }) => {
                ...
                <div className="px-6 py-4">
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder="Enter field name (e.g. Hobbies)"
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder="Enter field label (e.g. Your Hobbies)"
                                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-200"
                                value={newFieldLabel}
